...
public class RegisterUserHandler implements RequestHandler<AwsProxyRequest, AwsProxyResponse> {
    ...
    public AwsProxyResponse handleRequest(AwsProxyRequest awsProxyRequest, Context context) {
        ...
        try {
            ...
            awsProxyResponse.setBody(GatewayResponse.createError("Error during registration user").toString());
